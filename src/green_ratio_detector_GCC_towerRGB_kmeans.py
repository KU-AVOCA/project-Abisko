...
imoutfolder = '/mnt/i/SCIENCE-IGN-ALL/AVOCA_Group/1_Personal_folders/1_Simon/1_Abisko/6_Tower_Data/Tower RGB images/1_Data_greenessByShunan_kmeans'
...
def quantify_vegetation(img):
    ...
    Also separates green vegetation into two classes (trees and understory) using K-means clustering.
