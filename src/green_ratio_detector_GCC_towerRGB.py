...
#%%
imfolder = '/mnt/i/SCIENCE-IGN-ALL/AVOCA_Group/1_Personal_folders/1_Simon/1_Abisko/6_Tower_Data/Tower RGB images/1 Data'
imfiles = []
...
imoutfolder = '/mnt/i/SCIENCE-IGN-ALL/AVOCA_Group/1_Personal_folders/1_Simon/1_Abisko/6_Tower_Data/Tower RGB images/1_Data_greenessByShunan'
...
with open(csv_path, 'w') as f:
    f.write('filename,datetime,green_ratio\n')
#%%
...
for i in tqdm.tqdm(imfiles, desc="Processing images"):
    ...
    if ratio is not None:
        ...
        with open(csv_path, 'a') as f:
            f.write(f'{i},{datetime_str},{ratio}\n')
